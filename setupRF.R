...
####        PATH NAMES
#
#           path_out            path for output of .rda files after the RF training
#           
#

# Modify this line according to OWN PATH
...
# CREATE POSSIBLE EXPLAINED (UNIVARIATE) VARIABLE COMBINATIONS
